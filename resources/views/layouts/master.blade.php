...
<div class="wrapper" id="app">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{asset('images/logo.png')}}" alt="NMFU Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">NMFU</span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <div class="float-right d-none d-sm-inline">
      Designed by <strong>Adetona Sunday</strong>
    </div>
    <!-- Default to the left -->
    <strong>Copyright &copy; 2018 <a href="https://altitude-tech.com">NMFU Application</a>.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
